...
namespace AkiDevCat.AVL.Components
{
    public partial class VolumetricLight
    {
        ...
        public Vector3 PrimaryAngleRadCached { get; private set; }
        
        public Vector3 SecondaryAngleRadCached { get; private set; }
        ...
        public void UpdateLightCacheForce()
        {
            ...
            if (TransformCached.hasChanged || _lightRangeInvalidated)
            {
