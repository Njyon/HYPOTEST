...
public class Blend3DAimKickAwayAttack : AttackBase
{
	...
	void HitObj(GameObject hitObj)
	{
		...
		if (gc != null)
		{
			...
			Weapon.KickAway(gc, attackData.stunTime, (gc.MovementComponent.CharacterCenter - GameCharacter.MovementComponent.CharacterCenter).normalized, attackData.kickAwayStrenght, true);
